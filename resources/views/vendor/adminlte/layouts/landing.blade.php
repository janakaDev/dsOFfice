    ...
    <div id="navigation" class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><b>OFFICEmATE</b></a>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                   <!-- There will be navbar items to adds(jsb)-->
                </ul>
...
<script type="text/javascript">
        ...
        <script src="js/ace/moment.min.js"></script>
        <script src="js/ace/fullcalendar.min.js"></script>
